const translation = {
  ...
  welcome: '👋 Welcome to AI Agent Builder, please log in to continue.',
  email: 'Email address',
  ...
  timezone: 'Time zone',
  go: 'Go to MoneyForward Agent Builder',
  ...
  license: {
    tip: 'Before starting MoneyForward Agent Builder Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on MoneyForward Org',
  invalid: 'The link has expired',
  explore: 'Explore Agent Builder',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on MoneyForward and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The MoneyForward Enterprise license for your workspace has expired. Please contact your administrator to continue using MoneyForward.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect MoneyForward license server. Please contact your administrator to continue using MoneyForward.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The MoneyForward Enterprise license for your workspace is inactive. Please contact your administrator to continue using MoneyForward Agent Builder.',
  webapp: {
    login: 'Login',
