const translation = {
  ...
  externalAPIPanelDescription: 'The external knowledge API is used to connect to a knowledge base outside of MoneyForward Agent Builder and retrieve knowledge from that knowledge base.',
  ...
  didYouKnow: 'MoneyForward Integration',
  intro1: 'You can connect your MoneyForward Subscription and Product data to Agent Builder ',
  intro2: 'as context for your AI agents',
  intro3: ',',
  intro4: 'enabling intelligent automation ',
  intro5: 'of your back office operations',
