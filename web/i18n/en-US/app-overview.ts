const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Or try the cloud version of MoneyForward Agent Builder with free quote',
  },
  overview: {
    title: 'Overview',
    appInfo: {
      explanation: 'Enterprise-ready AI business application',
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see MoneyForward\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Install MoneyForward Agent Builder Chatbot Chrome Extension',
        copied: 'Copied',
        copy: 'Copy',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'MoneyForward-Agent-Builder-WebClient',
