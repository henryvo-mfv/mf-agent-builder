const translation = {
  ...
  join: 'About MoneyForward',
  communityIntro:
    'Learn more about MoneyForward and our enterprise solutions for back office operations.',
  ...
  newApp: {
    ...
    chatbotShortDescription: 'Enterprise-grade AI assistant for customer engagement',
    chatbotUserDescription: 'Deploy professional AI assistants to enhance customer service and support operations with enterprise-level configuration.',
    completionShortDescription: 'Business AI assistant for content generation',
    completionUserDescription: 'Create intelligent business solutions for content generation, documentation, and automated text processing.',
    agentShortDescription: 'Autonomous AI agent for business process automation',
    agentUserDescription: 'Deploy intelligent agents that automate complex business processes with advanced reasoning and tool integration.',
    workflowShortDescription: 'Enterprise workflow automation platform',
    workflowUserDescription: 'Design and deploy scalable AI-powered business workflows with visual process management.',
  ...
  tracing: {
    ...
    aliyun: {
      title: 'Cloud Monitor',
      description: 'The fully-managed and maintenance-free observability platform provided by Alibaba Cloud, enables out-of-the-box monitoring, tracing, and evaluation of MoneyForward Agent Builder applications.',
    },
    inUse: 'In use',
    configProvider: {
      title: 'Config ',
